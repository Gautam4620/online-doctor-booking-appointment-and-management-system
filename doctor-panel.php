...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Online Doctors </a>
...
.text-primary {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <img class ="doc-logo" src="https://i.ibb.co/Tm6kLn9/Doctor-5817903-1920.png" alt="Doctor-logo" border="0">
    </div>
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h1 style = "margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex San', sans-serif, font-weight: bold;"> Welcome Dr.&nbsp<?php echo $_SESSION['dname'] ?>  </h1>
    <div class="row">
