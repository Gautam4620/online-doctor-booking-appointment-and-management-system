...
<body style="background: -webkit-linear-gradient(left, #EF3B36, #fff); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;">
                <h4><i class="fa fa-user-plus" aria-hidden="true"></i>Online Doctors</h4>
            </a>
            ...
            <div>
            <img class="logo-hospital"  src="https://i.ibb.co/DQpMztQ/7d8b7eaff56ec97e6df928bce9bd9f3d-removebg-preview.png" alt="7d8b7eaff56ec97e6df928bce9bd9f3d-removebg-preview" border="0">
            </div>
        </div>
    ...
    <div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
        <div class="row">
            <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                <img src="images/Screenshot 2025-03-17 164335.png" alt="" />
                <h1>Welcome</h1>
            ...
            <div class="col-md-9 register-right " style="margin-top: 40px;left: 80px;">
                <ul class="nav nav-tabs nav-justified btn-danger" id="myTab" role="tablist" style="width: 40%;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#admin" role="tab" aria-controls="admin" style="color:white;" aria-selected="false">Admin</a>
                    </li>
                </ul>
    ...
    <div class="container thankyou" style="font-family: 'IBM Plex Sans', sans-serif;">
        <div class="col-md-10 register-left" style="margin-bottom: 5%; left: 13%">
                
                <h5>&copy 2025 online doctors</h5>
